!function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        var Checkout = function(version, scriptLocation) {
            ...
            Array.prototype.map || (Array.prototype.map = function(callback, thisArg) {
                ...
                for (arguments.length > 1 && (T = thisArg),
                A = new Array(len),
                k = 0; k < len; ) {
            ...
            var configuration = {}
              ...
              , cancel = function() {
                if (document.location.hash.indexOf('__hc-action-cancel') >= 0)
                    return returnMerchantHash(),
                    !0
            }()
              , interactionTimeout = function() {
                if (document.location.hash.indexOf('__hc-action-timeout') >= 0)
                    return returnMerchantHash(),
                    !0
            }()
              , complete = function() {
                ...
                if (found) {
                    var result = {};
                    return result.resultIndicator = found[1],
                    found[2] && (result.sessionVersion = found[2]),
                    returnMerchantHash(),
                    result
                }
            }()
              , lightbox = function() {
                var iframe, startLocation, originalOverflowStyle = {}, originalBodyStyle = {}, createIFrame = function(src) {
                    return startLocation = src,
                    'undefined' == typeof iframe && (iframe = document.createElement("iframe"),
                    ...
                    isFixed ? (iframe.style.backgroundColor = "white",
                    document.body.style.position = 'fixed',
                    document.body.style.width = '100%',
                    document.body.style.height = '100%') : (document.body.style.position = originalBodyStyle.position,
                    ...
                    iframe.src = startLocation,
                    params = params ? params : [],
                    'function' == typeof callback && callback.apply(null, params))
                    ...
                    if (state.set(SESSION_ID_PARAM, params.sessionId),
                    callbacks.hasOwnProperty('beforeRedirect')) {
                    ...
                    for (var key in elements)
                        elements.hasOwnProperty(key) && func(key, elements[key])
                        ...
                        if ('object' == typeof value)
                            if (value instanceof Array) {
                                ...
                                for (var i = 0, len = value.length; i < len; i++)
                                    'object' == typeof value[i] ? flatten(value[i], resultKey + '[' + i + ']', result) : result[resultKey + "[" + i + "]"] = value[i]
                            } else
                    ...
                    params && (url = buildUrl(url, params, paramNames)),
              ...
              , printMessage = function(message, level) {
                if (window.console) {
                    if (level && console[level])
                        return void console[level](message);
                    console.log(message)
                }
            }
              ...
              , embedMasterpassClient = function(urlString) {
                if (!("undefined" != typeof MasterPass && "undefined" != typeof MasterPass.client || "https://www.masterpass.com/lightbox/Switch/integration/MasterPass.client.js" !== urlString && "https://sandbox.masterpass.com/lightbox/Switch/integration/MasterPass.client.js" !== urlString)) {
                    var elementById = document.getElementById("tnsMasterpassSdkScript");
                    if (!elementById) {
                        var script = document.createElement('script');
                        script.setAttribute("id", "tnsMasterpassSdkScript"),
              ...
              , initCallback = function(scriptTag, callBackType) {
                ...
                if (scriptAttribute && '' !== scriptAttribute) {
                    ...
                    if (callback) {
                        if ('function' != typeof callback && 'string' != typeof callback)
                            throw 'Callback defined as \'' + scriptAttribute + '\' in \'' + scriptRef + '\' is not a function or string';
                        callbacks[callBackType] = callback
                    } else
                        callbacks[callBackType] = scriptAttribute
                }
            }
              , setupCallbacks = function(scriptTag) {
                initCallback(scriptTag, 'error'),
                initCallback(scriptTag, 'cancel'),
                initCallback(scriptTag, 'afterRedirect'),
                initCallback(scriptTag, 'beforeRedirect'),
                initCallback(scriptTag, 'complete'),
              ...
              , runAdditionalCallbacks = function() {
                ...
                complete && lightbox.complete(complete),
                interactionTimeout && lightbox.interactionTimeout({
              ...
              , initialize = function() {
                ...
                xd = xDomain(iframe.contentWindow, '*'),
                xd.listen('cancel', lightbox.cancel),
                xd.listen('error', lightbox.error),
                xd.listen('complete', lightbox.complete),
                xd.listen('interactionTimeout', lightbox.interactionTimeout),
                xd.listen('redirect', lightbox.redirect),
                xd.listen('hostPageInfo', lightbox.hostPageInfo),
                xd.listen('clearState', lightbox.clearState),
                xd.listen('activate', activate),
                xd.listen('embedMasterpassClient', embedMasterpassClient),
                xd.listen('lightboxInitialised', lightbox.initialised),
                runAdditionalCallbacks(),
                shouldResumeSession() ? (restoreMerchantState(),
              ...
              , shouldResumeSession = function() {
                return state.get(SESSION_ID_PARAM) && 'undefined' !== state.get(SESSION_ID_PARAM) && 'undefined' != typeof state.get(SESSION_ID_PARAM)
            }
            ...
            var showLightbox = function() {
              ...
              , copy = function(obj) {
                ...
                newObj = {};
                for (var key in obj)
                    obj.hasOwnProperty(key) && (newObj[key] = copy(obj[key]));
                return newObj
            }
              , marshall = function(data) {
                if (null === data || "object" != typeof data)
                    return "function" == typeof data ? data() : data;
                var copy = {};
                if (data instanceof Array) {
                    copy = [];
                    for (var i = 0, len = data.length; i < len; i++)
                        copy[i] = marshall(data[i]);
                    return copy
                }
                for (var key in data) {
                    var type = typeof data[key]
                      , value = data[key];
                    'function' === type ? copy[key] = value() : 'object' === type ? copy[key] = marshall(value) : copy[key] = value
                }
                return copy
            }
              , FormState = function() {
                ...
                return {
                    ...
                    restoreFormFields: restoreFormFields
                }
            }();
            return {
    ...
    2: [function(require, module, exports) {
        !function() {
                ...
                var hasSessionId = function(config) {
                  ...
                  , validate = function(config, callbacks, validationCallback) {
                    ...
                    if (paymentPage.hasOwnProperty('cancelUrl'))
                        throw invalidRequest("Unexpected parameter '" + interaction + ".cancelUrl'");
                    if (paymentPage.hasOwnProperty('timeoutUrl'))
                        throw invalidRequest("Unexpected parameter '" + interaction + ".timeoutUrl'");
                    if (config.order && config.order.netAmount && config.order.amount)
                        throw invalidRequest("Either order.amount or order.netAmount must be defined");
                    if (config.order && config.order.netAmount && config.interaction && 'NONE' === config.interaction.operation)
                        throw invalidRequest("order.netAmount must not be defined when interaction.operation is defined with a value of 'NONE'.");
                    if (config.order && config.order.surchargeAmount)
                    ...
                    if (callbacks.hasOwnProperty('timeout') && config.version < 51)
                        throw invalidRequest("Callback defined by 'data-timeout' is not available in version " + config.version + ". Please use version 51 or above.");
                    if (!hasSessionId(config) && hasSubMerchantDetails(config))
                  ...
                  , forEach = function(array, func) {
                    for (var k in array)
                        array.hasOwnProperty(k) && func(array[k], k)
                }
                  , validateCallbacksAreFunctions = function(callbackObject, callbackNames) {
                    forEach(callbackNames, function(callback) {
                        if (callbackObject.hasOwnProperty(callback) && 'function' != typeof callbackObject[callback])
                            throw invalidRequest("Callback defined by 'data-" + callback + "' must be of type function")
                    })
                }
            ...
            'undefined' != typeof module ? module.exports = validator : window.validator = validator
        }()
    }
    , {}],
                    ...
                    if (!has("json")) {
                        ...
                        if ((isProperty = objectProto.hasOwnProperty) || (isProperty = function(property) {
                            ...
                            members).toString != getClass ? isProperty = function(property) {
                                ...
                                this);
                                return this.__proto__ = original,
                                result
                            }
                        ...
                        forEach = function(object, callback) {
                            ...
                            size ? forEach = 2 == size ? function(object, callback) {
                            ...
                            : function(object, callback) {
                                ...
                                for (property in object)
                                    isFunction && "prototype" == property || !isProperty.call(object, property) || (isConstructor = "constructor" === property) || callback(property);
                            ...
                            var Escapes = {
                              ...
                              , serialize = function(property, object, callback, properties, whitespace, indentation, stack) {
                                ...
                                if ("object" == typeof value && value)
                                    if (className = getClass.call(value),
                                    className != dateClass || isProperty.call(value, "toJSON"))
                                        "function" == typeof value.toJSON && (className != numberClass && className != stringClass && className != arrayClass || isProperty.call(value, "toJSON")) && (value = value.toJSON(property));
                                    else if (value > -1 / 0 && value < 1 / 0) {
                                        if (getDay) {
                                            for (date = floor(value / 864e5),
                                            year = floor(date / 365.2425) + 1970 - 1; getDay(year + 1, 0) <= date; year++)
                                                ;
                            ...
                            exports.stringify = function(source, filter, width) {
                                ...
                                if (width)
                                    if ((className = getClass.call(width)) == numberClass) {
                                        ...
                                        className == stringClass && (whitespace = width.length <= 10 ? width : width.slice(0, 10));
                        ...
                        if (!has("json-parse")) {
                            var Index, Source, fromCharCode = String.fromCharCode, Unescapes = {
                                ...
                                for (var value, begin, position, isSigned, charCode, source = Source, length = source.length; Index < length; )
                                    ...
                                    case 34:
                                        for (value = "@",
                                        Index++; Index < length; )
                                            if (charCode = source.charCodeAt(Index),
                                            charCode < 32)
                                                abort();
                                            else if (92 == charCode)
                                                switch (charCode = source.charCodeAt(++Index)) {
                                                ...
                                                case 117:
                                                    for (begin = ++Index,
                                                    position = Index + 4; Index < position; Index++)
                                                ...
                                                if (34 == charCode)
                                                    break;
                                                for (charCode = source.charCodeAt(Index),
                                                begin = Index; charCode >= 32 && 92 != charCode && 34 != charCode; )
                                                    charCode = source.charCodeAt(++Index);
                                    ...
                                    default:
                                        if (begin = Index,
                                        45 == charCode && (isSigned = !0,
                                        charCode = source.charCodeAt(++Index)),
                                        charCode >= 48 && charCode <= 57) {
                                            for (48 == charCode && (charCode = source.charCodeAt(Index + 1),
                                            charCode >= 48 && charCode <= 57) && abort(),
                                            isSigned = !1; Index < length && (charCode = source.charCodeAt(Index),
                                ...
                                "string" == typeof value) {
                                    ...
                                    if ("[" == value) {
                                        for (results = []; value = lex(),
                                        "]" != value; hasMembers || (hasMembers = !0))
                            ...
                            exports.parse = function(source, callback) {
                                ...
                                "$" != lex() && abort(),
                                Index = Source = null,
                                callback && getClass.call(callback) == functionClass ? walk((value = {},
                                value[""] = result,
                                value), "", callback) : result
                            }
                        }
                    }
                    return exports.runInContext = runInContext,
                    exports
                }
                ...
                freeExports && !isLoader)
                    ...
                    var nativeJSON = root.JSON
                      ...
                      , JSON3 = runInContext(root, root.JSON3 = {
                        "noConflict": function() {
                            return isRestored || (isRestored = !0,
    ...
    4: [function(require, module, exports) {
        !function() {
            ...
            var stateImpl = function() {
                ...
                try {
                    implementation.setByKey("_test", "test"),
                    implementation.getByKey("_test"),
                    implementation.removeByKey("_test")
                } catch (e) {
                    windowNameImplementation.initialise(),
                    implementation = windowNameImplementation
                }
                return {
            ...
            'undefined' != typeof module ? module.exports = stateImpl : window.windowState = stateImpl
        }()
    }
    , {
        "./json3.js": 3
        ...
        !function() {
            ...
            var xDomain = function(targetWindow, targetHost, name) {
                ...
                var listen = function(eventType, callback) {
                  ...
                  , receiveAndSend = function(event) {
                    var result, type = event.type, data = event.data;
                    type && callbacks.hasOwnProperty(type) && (result = callbacks[type](data)),
                    result && sendMessage(event.callback, result)
                };
            ...
            'undefined' != typeof module ? module.exports = xDomain : window.xDomain = xDomain
        }()
    }
    , {
        "./json3.js": 3
